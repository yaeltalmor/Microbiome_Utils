...
def main():
    ...
    param_grid = {"capacity": [{"lr": 1e-4, "dropout": 0.3,
                  ...
                  "time_emb_type": [TimeEmbeddingType.REL_POS_ENC],
                  "md_token": [True, False],
    ...
    results_dict, best_cfgs = run_model_selection(param_grid, train_idx, transformer_batch, NUM_YEARS=4)
